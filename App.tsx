          ...
          <div className="flex justify-between items-end">
            ...
            {proof && (
              <button 
                ...
                className="text-[10px] font-black text-red-500 uppercase tracking-widest bg-red-50 px-2 py-1 rounded"
              >
                Remove
              </button>
            )}
          ...
          {proof ? (
            <div className="relative group rounded-2xl overflow-hidden border border-slate-200">
              ...
              <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                 <button onClick={() => fileInputRef.current?.click()} className="bg-white text-slate-900 px-4 py-2 rounded-full text-xs font-bold shadow-lg">Change Photo</button>
              </div>
            </div>
          ) : (
            <div className="grid grid-cols-2 gap-3">
              <button 
                ...
                className="flex flex-col items-center justify-center gap-3 p-6 bg-blue-50 border-2 border-dashed border-blue-200 rounded-2xl active:bg-blue-100 transition-colors"
              >
                ...
                <span className="text-[10px] font-black text-blue-700 uppercase tracking-widest">Snap Photo</span>
              </button>
              ...
              <button 
                ...
                className="flex flex-col items-center justify-center gap-3 p-6 bg-slate-50 border-2 border-dashed border-slate-200 rounded-2xl active:bg-slate-100 transition-colors"
              >
                ...
                <span className="text-[10px] font-black text-slate-600 uppercase tracking-widest">Gallery</span>
              </button>
            </div>
          )}
